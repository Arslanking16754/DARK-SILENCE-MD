...
module.exports = {
    SESSION_ID: process.env.SESSION_ID || "DARK-SILENCE-MD~fRwF3KrD#Xd25JoBDKtV81h6TAyk5DNUgWyaBskIpc2sfw7hl2_U",
    CAPTION: process.env.CAPTION || "POWERED BY MR.AK",
    ...
    ALIVE_MSG: process.env.ALIVE_MSG || "HII DEAR IM ONLINE I'Mr-Ak-MD WHATSAPP BOT 😊♻️",
    ...
    OWNER_NUMBER: process.env.OWNER_NUMBER || "923493436993",
    OWNER_NAME: process.env.OWNER_NAME || "➺Mr-Ak࿐",
    READ_CMD: process.env.READ_CMD || "true",
    BOT_NAME: process.env.BOT_NAME || "➺Mr-Ak-MD",
